  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        travel: "bg-gradient-hero text-white shadow-travel hover:shadow-glow transition-bounce font-semibold",
        ocean: "bg-gradient-ocean text-white shadow-soft hover:shadow-travel transition-smooth",
        sunset: "bg-sunset text-sunset-foreground shadow-soft hover:bg-accent-light transition-smooth",
        sky: "bg-gradient-sky text-white shadow-soft hover:opacity-90 transition-smooth",
      },
      size: {
